...
#include "GoblinGame/TP_WeaponComponent.h"
...
GOBLINGAME_API UClass* Z_Construct_UClass_UTP_WeaponComponent();
GOBLINGAME_API UClass* Z_Construct_UClass_UTP_WeaponComponent_NoRegister();
...
struct Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon_Statics
{
	...
	{
		AGoblinGameCharacter* TargetCharacter;
		bool ReturnValue;
	};
#if WITH_METADATA
...
{
	P_GET_OBJECT(AGoblinGameCharacter,Z_Param_TargetCharacter);
	P_FINISH;
	P_NATIVE_BEGIN;
...
struct Z_Construct_UClass_UTP_WeaponComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon, "AttachWeapon" }, // 3693710428
...
template<> GOBLINGAME_API UClass* StaticClass<UTP_WeaponComponent>()
{
	return UTP_WeaponComponent::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_GitHub_GoblinGame_GoblinGame_Source_GoblinGame_TP_WeaponComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UTP_WeaponComponent, UTP_WeaponComponent::StaticClass, TEXT("UTP_WeaponComponent"), &Z_Registration_Info_UClass_UTP_WeaponComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTP_WeaponComponent), 581264096U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GitHub_GoblinGame_GoblinGame_Source_GoblinGame_TP_WeaponComponent_h_1024982712(TEXT("/Script/GoblinGame"),
	Z_CompiledInDeferFile_FID_GitHub_GoblinGame_GoblinGame_Source_GoblinGame_TP_WeaponComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_GitHub_GoblinGame_GoblinGame_Source_GoblinGame_TP_WeaponComponent_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
